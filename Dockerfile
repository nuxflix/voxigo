...
#
# Container image for the voxigo example bots. It bundles the two native
# dependencies voxigo needs — libsoxr (linked) and the ONNX Runtime (loaded at
...
RUN CGO_ENABLED=1 go build -ldflags="-s -w" -o /out/voxigo-bot ./examples/${EXAMPLE}
