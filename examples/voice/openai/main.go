// Command voice-openai is a headless voxigo voice backend.
//
// It uses OpenAI across the board — speech-to-text, the LLM, and text-to-speech.
//
...
import (
	...
	"github.com/nuxflix/voxigo/audio/noise/rnnoise"
...
func runBot(conn *rtc.Connection) {
	...
	//	VOXIGO_DENOISE=1 go run ./examples/voice/openai
