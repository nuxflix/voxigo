// Command voice-minimax is a headless voxigo voice backend.
//
// It uses MiniMax text-to-speech (MINIMAX_GROUP_ID required), with Deepgram STT and an Anthropic LLM.
//
...
func runBot(conn *rtc.Connection) {
	...
	tts := minimax.NewTTS(minimax.Config{
