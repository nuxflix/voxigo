...
Micro-benchmarks comparing voxigo (Go) with [Pipecat](https://github.com/pipecat-ai/pipecat)
(Python). Two families:
...
```sh
# voxigo (Go) — frame latency through a processor chain, and throughput scaling
...
# Pipecat (Python) — loads the same ONNX model files voxigo embeds
