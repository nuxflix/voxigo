...
// single cgo boundary in voxigo: the ONNX runtime shared library is located and
...
// library (libonnxruntime.so / .dylib / onnxruntime.dll). Point voxigo at it
// with the VOXIGO_ONNXRUNTIME_LIB environment variable:
//
